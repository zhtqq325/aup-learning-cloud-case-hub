...
智能论文问答助手是一个面向高校课程资料管理、科研文献阅读和批量比较分析场景的 Notebook 交互式系统。项目以“基于提示词工程与超长上下文处理的文献问答与对比分析系统”为技术底座，围绕论文导入、知识库构建、检索问答、单文档分析、多文档对比、结构化字段抽取与报告导出，构建了一个可落地、可复现、可解释的完整处理闭环。
